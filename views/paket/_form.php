...
<div class="paket-form">
    ...
    <?= $form->field($model, 'jenis_paket')->dropDownList([ 'Paket Sopir' => 'Paket Sopir', 'Paket Kendaraan' => 'Paket Kendaraan', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'denda_rp')->widget(MaskMoney::classname(), [
    'pluginOptions' => [
        'prefix' => 'Rp ',
          'allowNegative' => false,
             'precision' => 0
